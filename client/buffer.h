...
// Error when message received from server/GUI isn't fully loaded yet.
...
// Error when server/GUI sent wrong message.
...
class SendBuffer {
private:
    constexpr static size_t initial_length = UINT16_MAX;
...
public:
    ...
    inline bool did_read_all() {
        return processed == ptr;
    }
